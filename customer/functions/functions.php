                ...
                $count_orders = mysqli_num_rows($run_orders);
                            ...
                            if($count_orders>0){
                                echo 
                                    ...
                                    <h3>Please see your orders details by clicking this
                                    <a href='my_account.php?my_orders'>LINK</a>
                                    <br>
                                    Or you can
                                    <a href='pay_offline.php'>Pay Offline</a>
                                    </h3>
                                    ...
                                    <h3>Please see your orders history by clicking this
                                    <a href='my_account.php?my_orders'>LINK</a>
                                    <br>
                                    Or you can
                                    <a href='pay_offline.php'>Pay Offline</a>
